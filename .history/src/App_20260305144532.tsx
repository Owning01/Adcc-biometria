    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px', position: 'relative', zIndex: 1 }}>
        <div style={{
          ...
          <img src={adccLogo} alt="Logo ADCC" style={{ width: '58px', filter: 'drop-shadow(0 0 12px rgba(212,175,55,0.5))' }} />
        </div>
        <h1 style={{ fontSize: '1.8rem', fontWeight: '900', margin: 0, letterSpacing: '-0.5px' }}>
          ADCC <span style={{ color: 'var(--primary)', textShadow: '0 0 20px rgba(212,175,55,0.4)' }}>BIOMETRIC</span>
        </h1>
