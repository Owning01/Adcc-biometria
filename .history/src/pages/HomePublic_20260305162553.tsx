            ...
            <div className="home-public-immersive" style={{
                ...
                <section style={{
                    ...
                    >
                        <m.img
                            src={AppLogo}
                            alt="Logo"
                            style={{ width: '140px', marginBottom: '30px', filter: 'drop-shadow(0 0 20px rgba(255,255,255,0.2))' }}
                            animate={{ y: [0, -10, 0] }}
                ...
                <section style={{
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '40px' }}>
                        ...
                        >
                            <h3 style={{ fontSize: '0.9rem', color: '#3b82f6', fontWeight: '800', letterSpacing: '3px', marginBottom: '10px' }}>EN VIVO</h3>
                ...
                <section style={{
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '40px', alignItems: 'flex-end', textAlign: 'right' }}>
                        <m.div
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            <h3 style={{ fontSize: '0.9rem', color: '#d4af37', fontWeight: '800', letterSpacing: '3px', marginBottom: '10px' }}>ELITE</h3>
                ...
                <section style={{
                    ...
                    <footer style={{ position: 'absolute', bottom: '40px', width: '100%', textAlign: 'center' }}>
