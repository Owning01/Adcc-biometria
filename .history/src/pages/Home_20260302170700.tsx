...
const Home = ({ userRole }: { userRole?: string }) => {
    ...
    useEffect(() => {
        ...
        syncADCCData(1).catch(err => console.error("Auto-sync failed:", err));
                                    ...
                                    <div key={team} onClick={() => setSelectedTeam(team)} className="team-card">
                                        <div className="hexagon-container">
                                            <div className="team-card-content">
                                                {teamData?.logoUrl ? (
                                                    <img src={teamData.logoUrl} alt={team} className="team-logo-img" style={{ width: '45px', height: '45px', objectFit: 'contain', marginBottom: '8px' }} />
                                                ) : teamData?.adccLogoUrl ? (
                                                    <img src={getAdccImageUrl(teamData.adccLogoUrl)} alt={team} className="team-logo-img" style={{ width: '45px', height: '45px', objectFit: 'contain', marginBottom: '8px' }} />
                                                ) : (
                                        ...
                                        <div key={match.id} className="match-log-entry" onClick={() => navigate(`/partido/${match.id}`)}>
                                            ...
                                            <div className="match-teams-list">
                                                <div className="match-team-row">
                                                    {teamALogo ? (
                                                        <img src={teamALogo} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', marginRight: '6px' }} />
                                                    ) : match.teamA.logo ? (
                                                        <img src={getAdccImageUrl(match.teamA.logo)} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', marginRight: '6px' }} />
                                                    ) : (
                                                ...
                                                <div className="match-team-row">
                                                    {teamBLogo ? (
                                                        <img src={teamBLogo} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', marginRight: '6px' }} />
                                                    ) : match.teamB.logo ? (
                                                        <img src={getAdccImageUrl(match.teamB.logo)} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', marginRight: '6px' }} />
                                                    ) : (
                                                        <div style={{ width: '16px', height: '16px', marginRight: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px' }}></div>
                                                    )}
                                    ...
                                    <div key={u.id} className="record-item group" onClick={() => { setPreviewImage(u.photo); }}>
                                        <div className="record-avatar-wrapper">
                                            <div className="record-avatar">
                                                {u.photo ? (
                                                    <img src={getAdccImageUrl(u.photo)} className="w-full h-full object-cover transition-transform group-hover:scale-110" alt={`Foto de ${u.name || 'Usuario'}`} />
                                                ) : (
                                                ...
                                                <tr key={u.id} className="table-premium-row">
                                                    ...
                                                    <td className="table-premium-cell text-center">
                                                        <input
                                                            ...
                                                            disabled={userRole !== 'admin' && userRole !== 'dev'}
                                                        />
                                                    </td>
                                                    ...
                                                    <td className="table-premium-cell text-center">
                                                        <StatusBadge
                                                            ...
                                                            onClick={() => (userRole === 'admin' || userRole === 'dev') && handleToggleStatus(u, selectedCategory)}
                                                        />
                                                    </td>
