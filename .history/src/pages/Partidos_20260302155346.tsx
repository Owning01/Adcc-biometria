                                ...
                                <div className="match-card-grid" style={{ minWidth: 0, overflow: 'hidden' }}>
                                    <div className="match-card-team" style={{ minWidth: 0 }}>
                                        <div className="team-logo-container">
                                            {match.teamA?.logo ? <img src={match.teamA.logo} alt={`Logo de ${match.teamA.name}`} /> : <Trophy size={20} opacity={0.2} aria-hidden="true" />}
                                        </div>
                                    ...
                                    <div className="match-card-team" style={{ minWidth: 0 }}>
                                        <div className="team-logo-container">
                                            {match.teamB?.logo ? <img src={match.teamB.logo} alt={`Logo de ${match.teamB.name}`} /> : <Trophy size={20} opacity={0.2} aria-hidden="true" />}
                                        </div>
