...
const DevTools: React.FC = () => {
    ...
    const handleSyncAllADCCPlayers = async () => {
        if (!confirm("Esto sincronizará todos los jugadores únicos de los partidos actuales (aprox. 3 páginas de resultados). ¿Continuar?")) return;
                    ...
                    allPlayers.forEach(p => {
                        ...
                        if (!playersMap.has(dni)) {
                            playersMap.set(dni, {
                                name: `${p.nombre} ${p.apellido}`,
                                dni: dni,
                                team: p.equipo_nombre || (detail.equipo_local.includes(p) ? match.local_nombre : match.visitante_nombre),
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '15px' }}>
                                                <div style={{ flex: 1, textAlign: 'center' }}>
                                                    <div style={{ width: '60px', height: '60px', background: 'rgba(255,255,255,0.05)', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '8px', margin: '0 auto 10px' }}>
                                                        <img src={match.local_escudo} alt={match.local_nombre} style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                                                    </div>
                                                ...
                                                <div style={{ flex: 1, textAlign: 'center' }}>
                                                    <div style={{ width: '60px', height: '60px', background: 'rgba(255,255,255,0.05)', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '8px', margin: '0 auto 10px' }}>
                                                        <img src={match.visitante_escudo} alt={match.visitante_nombre} style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                                                    </div>
