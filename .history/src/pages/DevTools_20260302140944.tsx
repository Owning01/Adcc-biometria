            ...
            <div className="container animate-fade-in">
                ...
                <div style={{ display: 'flex', gap: '12px', marginBottom: '30px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-6 py-3 rounded-xl transition-all ${mode === 'adcc' ? 'bg-indigo-600 text-white shadow-lg' : 'bg-white text-slate-600 hover:bg-slate-50'}`}
                    >
