    ...
    return (
        <LazyMotion features={domAnimation}>
            <div className="home-public-immersive" style={{
                ...
                alignItems: 'center',
                paddingTop: '40px', // Reduced padding as navbar is gone for public
                overflowX: 'hidden',
                zIndex: 0
            }}>
                ...
                <div style={{
                    ...
                    <m.div
                        ...
                        style={{
                            ...
                            alignItems: 'center',
                            textAlign: 'center',
                            backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(${PelotaImg})`,
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                            color: '#fff',
                            padding: '40px 20px',
                    ...
                    >
                        ...
                        <p style={{ fontSize: '1.1rem', maxWidth: '280px', fontWeight: '700', marginBottom: '30px', color: 'rgba(255,255,255,0.8)' }}>
                    ...
                    <m.div
                        ...
                        style={{
                            ...
                            backgroundSize: 'cover', // Fixed from 100% 100% to avoid stretching/cropping issues
                            backgroundPosition: 'center',
                            backgroundRepeat: 'no-repeat',
