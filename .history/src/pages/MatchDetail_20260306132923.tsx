                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: 'auto' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', padding: '2px' }}>
                                            ...
                                            <div style={{ minWidth: '40px', textAlign: 'center', fontSize: '0.9rem', fontWeight: 'bold', color: 'var(--text-main)', whiteSpace: 'nowrap' }}>{p.goals || 0} <span style={{ fontSize: '0.7rem', opacity: 0.6 }}>GOLES</span></div>
                                            <button
