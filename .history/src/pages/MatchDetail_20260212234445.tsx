...
const MatchDetail = ({ userRole }: { userRole: string }) => {
    ...
    const submitMatchReport = async () => {
        ...
        const payload = {
            ...
            res_local_p: reportData.res_local_p,
            res_visitante: match.score.b,
            res_visitante_p: reportData.res_visitante_p,
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    {(isAdminOrDev || isReferee) && (
                        <button
                            ...
                            style={{ background: 'var(--primary)', color: 'black', fontWeight: 'bold', fontSize: '0.8rem' }}
                        >
                            <Save size={16} /> CARGAR PLANILLA OFICIAL
                        </button>
                    )}
...
const SquadColumn = ({ title, players, teamType, onAdd, onSubstitution, onUpdate, onRemove, isReferee, userRole }: any) => {
