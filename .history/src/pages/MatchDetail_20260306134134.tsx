                            ...
                            {['scheduled', 'live', 'halftime', 'finished'].map(st => (
                                ...
                                >
                                    ...
                                    {st === 'scheduled' ? 'PROGRAMADO' :
                                        st === 'live' ? 'EN VIVO' :
                                            st === 'halftime' ? 'ENTRETIEMPO' :
                                                st === 'finished' ? 'FINALIZADO' : st.toUpperCase()}
                                </button>
                            ))}
                        </div>
                    ) : (
                        ...
                        <div className="flex-center" style={{ gap: '15px' }}>
                            {isAdminOrDev || isReferee ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                                    ...
                                    <button onClick={() => handleScoreChange('a', -1)} className="score-control-btn" style={{ fontSize: '0.8rem', height: '25px', opacity: 0.7 }}>-</button>
                                </div>
                            ) : null}
                            ...
                            {isAdminOrDev || isReferee ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                                    ...
                                    <button onClick={() => handleScoreChange('b', -1)} className="score-control-btn" style={{ fontSize: '0.8rem', height: '25px', opacity: 0.7 }}>-</button>
                                </div>
                            ) : null}
                        </div>
                        {match.status === 'live' && (
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', background: 'rgba(255,255,255,0.08)', borderRadius: '8px', padding: '1px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                            <button
                                                ...
                                                style={{ background: 'none', border: 'none', color: '#ef4444', cursor: 'pointer', padding: '4px', display: 'flex', alignItems: 'center', opacity: (parseInt(p.goals) || 0) <= 0 ? 0.2 : 1 }}
                                                title="Restar Gol"
                                            >
                                                <Minus size={16} />
                                            </button>
