                        ...
                        {matches.map((match: any) => (
                            ...
                            >
                                ...
                                <div style={{ fontSize: '0.85rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                    <span style={{ flex: 1, textAlign: 'right', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{match.local_nombre || match.equipo1_nombre}</span>
                                    <span style={{ fontSize: '0.7rem', color: 'var(--primary)' }}>VS</span>
                                    <span style={{ flex: 1, textAlign: 'left', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{match.visitante_nombre || match.equipo2_nombre}</span>
                                </div>
                        ...
                        <div className="glass-premium" style={{ padding: '24px', position: 'relative', overflow: 'hidden' }}>
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                ...
                                <h2 style={{ fontSize: '1.4rem', fontWeight: 900, marginBottom: '4px' }}>
                                    {currentMatch.local_nombre || currentMatch.equipo1_nombre} vs {currentMatch.visitante_nombre || currentMatch.equipo2_nombre}
                                </h2>
                                <div style={{ fontSize: '0.9rem', opacity: 0.7, display: 'flex', gap: '16px' }}>
                                    <span>{currentMatch.torneo_nombre}</span>
                                </div>
                            </div>
                        </div>
                    ) : (
                                    ...
                                    return (
                                        <div key={p.jleid} className="glass-panel" style={{
                                            ...
                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                ...
                                                <div style={{ fontSize: '0.6rem', opacity: 0.5 }}>{p.equipo || p.equipo_nombre}</div>
                                            </div>
                                        </div>
                                    );
                                })}
