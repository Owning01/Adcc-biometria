                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                const pass = prompt('Ingrese contraseña para eliminar los datos del equipo:');
                                                if (pass === '44583') {
                                                    if (confirm(`¿Está seguro de eliminar TODOS los registros del equipo ${team}? Esta acción no se puede deshacer.`)) {
                                                        playerRegistrationService.deleteTeamData(team).then(res => {
                                                            if (res.success) {
                                                                alert(`Se eliminaron ${res.deletedCount} jugadores exitosamente.`);
                                                            } else {
