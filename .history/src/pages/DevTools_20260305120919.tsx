...
import { Terminal, Upload, Play, RefreshCw, ClipboardPaste, Database, Trophy, ArrowLeft } from 'lucide-react';
            ...
            <div className="container animate-fade-in">
                <header style={{ marginBottom: '30px', textAlign: 'center' }}>
                    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary)', padding: '8px 16px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 'bold', marginBottom: '15px' }}>
                        ...
                        <div style={{ minHeight: '100vh', background: 'var(--background-color)', padding: '40px 20px' }}>
                            <div style={{ maxWidth: '1200px', margin: '0 auto', marginBottom: '40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <div>
                            ...
                            <div style={{ display: 'flex', gap: '10px', marginBottom: '30px', maxWidth: '1200px', margin: '0 auto 30px' }}>
                                <button
