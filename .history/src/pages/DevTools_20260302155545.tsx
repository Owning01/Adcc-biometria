...
const DevTools: React.FC = () => {
    ...
    const compressAndUploadLogo = (url: string, teamId: string): Promise<string> => {
        return new Promise((resolve, reject) => {
            const img = new Image();
            // Intentar cargar a través del proxy si es una URL de ADCC para evitar CORS
            const proxyUrl = url.includes('adccanning.com.ar')
                ? url.replace('https://adccanning.com.ar', '/api-adcc')
                : url;
