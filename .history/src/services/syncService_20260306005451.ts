    ...
    try {
        ...
        for (const league of leagues) {
            ...
            for (const match of matches) {
                ...
                await saveTeam({ id: teamAId, name: match.local_nombre, adccLogoUrl: match.local_escudo || null, logoUrl: logoUrlA });
                ...
                await saveTeam({ id: teamBId, name: match.visitante_nombre, adccLogoUrl: match.visitante_escudo || null, logoUrl: logoUrlB });
