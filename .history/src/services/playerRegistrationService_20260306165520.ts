...
export const playerRegistrationService = {
    ...
    async registerPlayer(player: {
        ...
        try {
            ...
            const rawId = player.jleid || player.id || player.dni;
            ...
            const playerDoc = {
                id: player.jleid || player.id || player.dni || finalDocId,
                dni: player.dni || '',
                nombre: player.nombre || '',
                apellido: player.apellido || '',
                displayName: `${player.nombre || ''} ${player.apellido || ''}`.trim() || 'Jugador Desconocido',
