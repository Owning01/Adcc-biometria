...
export const createMatcher = (users: any[]): faceapi.FaceMatcher | null => {
    ...
    // 0.5 es más conservador que el estándar 0.6 para evitar falsos positivos.
    return labeledDescriptors.length > 0 ? new faceapi.FaceMatcher(labeledDescriptors, 0.5) : null;
};
