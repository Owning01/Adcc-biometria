...
const Navigation: React.FC<NavigationProps> = ({ userRole, onLogout, theme, toggleTheme }) => {
  ...
  return (
    <nav className="app-nav">
      ...
      <div className="nav-brand" style={{ display: 'flex', alignItems: 'center', gap: '15px', marginRight: '20px' }}>
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
          <img src={adccLogo} alt="Logo ADCC" style={{ height: '40px', objectFit: 'contain' }} />
          <img src={eyeLogo} alt="Eye Logo" style={{ height: '40px', objectFit: 'contain' }} className="hide-mobile" />
      ...
      {userRole !== 'public' && (
        <div onClick={onLogout} className="nav-item" style={{ cursor: 'pointer', color: '#f87171', marginLeft: 'auto' }}>
