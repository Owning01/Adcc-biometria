    ...
    <>
      <nav className="app-nav">
        ...
        <div className="nav-items-center hide-mobile">
          ...
          {/* Rutas Públicas */}
          <NavItem to="/partidos" icon={null} label="Partidos" active={location.pathname === "/partidos" || location.pathname.startsWith('/partido')} />
          ...
          {userRole === 'public' && (
            <NavItem to="/login" icon={null} label="Ingresar" active={location.pathname === "/login"} />
          )}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            {userRole !== 'public' && (
              <Link to="/" className="mobile-menu-item"><HomeIcon size={24} /> Inicio</Link>
            )}
            <Link to="/partidos" className="mobile-menu-item">Partidos</Link>
            {userRole !== 'public' && userRole !== 'usuario' && (
              <Link to="/equipos" className="mobile-menu-item"><Shield size={24} /> Torneos</Link>
            )}
            {userRole !== 'public' && (
              <Link to="/estadisticas" className="mobile-menu-item"><PieChart size={24} /> Estadísticas</Link>
            )}
            {userRole === 'public' && (
              <Link to="/login" className="mobile-menu-item">Ingresar</Link>
            )}
