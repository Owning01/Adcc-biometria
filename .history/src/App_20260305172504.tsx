...
import adccLogo from './img/Logo ADCC.png';
    ...
    <nav className="app-nav">
      <div className="nav-brand">
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
          ...
          <img src={eyeLogo} alt="Eye Logo" style={{ height: '35px', objectFit: 'contain' }} />
    ...
    <AnimatePresence>
      {isMenuOpen && (
        ...
        >
          ...
          <Link to="/partidos" className="mobile-menu-item"><Swords size={24} /> Partidos</Link>
          ...
          {userRole === 'public' && (
            <Link to="/login" className="mobile-menu-item"><LogIn size={24} /> Ingresar</Link>
          )}
