    ...
    <BrowserRouter>
      <div className="app-main-container">
        ...
        <main className="container" style={{
          paddingBottom: userRole === 'public' ? '0' : '120px',
          paddingTop: userRole === 'public' ? '0' : '40px',
          maxWidth: userRole === 'public' ? 'none' : undefined,
          margin: userRole === 'public' ? '0' : undefined,
          width: userRole === 'public' ? '100%' : undefined
        }}>
          <Routes>
