...
De ahi obtenemos, cual es el socio, el nombre, el apellido y su foto, pero si la foto viene con la variable  "face_api":null la foto es vieja, si viene "face_api_app" es nueva